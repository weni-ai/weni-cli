    ...
    def validate_parameters(self, parameters: dict) -> tuple[Any, Optional[str]]:
        ...
        for parameter in parameters:
            for parameter_name, parameter_data in parameter.items():
                ...
                if type(parameter_data.get("description")) is not str:
                ...
                if type(parameter_data.get("required", None)) is not bool:
                    return None, error(parameter_name, "'required' field must be a boolean")

                if parameter_data.get("contact_field", None) and type(parameter_data.get("contact_field")) is not bool:
